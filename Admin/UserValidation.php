              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="progress progress-slim">
                      <?php
                       echo '<div class="progress-bar bg-success-gadient" role="progressbar" style="width:'.$visitorcount.'%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>';
                      ?>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                  <h6 class="card-subtitle mb-4">Online Users</h6>
                  <div class="progress progress-slim">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                ...
                //count of users registered today from user_info table
                  ...
                  while($row=mysqli_fetch_array($UserPerDay))
                  {
                     $shopperday=$row[0]; 
                ...
                <p class="card-text">User Reg per day</p>
                  <div class="progress">
                  <?php
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                ...
                //revenue generated per day
                  ...
                  $perdaypers=($perdayamt/$totalAmt)*100;
                  $perdaypers =round($perdaypers);
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 grid-margin">
              <div class="card">
                ...
                <label for="exampleFormControlSelect1">Product Display</label>
                        ...
                        {
                         $loc=$_POST['detailssub'];
                           echo ' <div class="card-body">
                           <form class="forms-sample" action="#" method="POST">
                             <label for="exampleFormControlSelect1">Shop Display</label>
                             <select class="form-control form-control-lg" name="sshop" id="exampleFormControlSelect1">';
                            
                            include('../BackEnd/php/connection.php');
                            $productInfo = mysqli_query($con, "SELECT * FROM `shop_info` where `location`='$loc'");
                            while($row = mysqli_fetch_array($productInfo))
                                {
                                 $shopId= $row[0];
                                 echo $shopId;
                       ...
                       echo '</select><br>
                        <button type="submit" name="detailsshop" class="btn btn-success mr-2">Submit</button>
                        <button class="btn btn-light">Cancel</button>
                        <input type="text"  value='.$shopId.' name="shopID" hidden>
                        </div>';}
                        ?>
                        <div class="card-body">
                  ...
                  <?php
                   include('../BackEnd/php/connection.php');
                      if(isset($_POST['detailsshop']))
                      {
                         $shopId = $_POST['shopID'];
                         $name=$_POST['sshop'];
                         $query=mysqli_query($con, "SELECT * FROM `user_log` WHERE `ShopID`='$shopId'"); 
                         while($row1 = mysqli_fetch_array($query))
                           {
                                 $userID=$row1[2];
                                 $query1=mysqli_query($con, "SELECT * FROM `user_info` WHERE `UserId`='$userID'"); 
                                 while($row = mysqli_fetch_array($query1))
                                 {
                                      
                                      $superid=$row[0];
                                      echo '<tr><td class="text-right">'.$row[1].'</td><td>'.$row[2].'</td><td>'.$row[3].'</td><td>'.$row[5].'</td><td>'.$row[8].'</td></tr>';
                                 }
                             }
